...
namespace Alexa.Controllers
{
    public class CustomBaseController : ControllerBase
    {
        ...
        public CustomBaseController(SecondaryDbContext context, IMapper mapper)
        {
            ...
            where TEntidad : class
        {
            ...
            await HttpContext.InsertarParametrosPaginacion(queryable, paginacionDTO.Pagina);
